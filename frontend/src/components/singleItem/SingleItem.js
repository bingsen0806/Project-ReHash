    ...
    return (
        <div className="singleItemWrapper">
            <Carousel responsive={responsive}>
                <Carousel.Item>
                    <img className="d-block w-100" src="/assests/singleItemPics/keychronK2Pic1.jpg" alt="" />
                </Carousel.Item>
                <Carousel.Item>
                    <img className="d-block w-100" src="/assests/singleItemPics/keychronK2Pic2.jpg" alt="" />
                </Carousel.Item>
                <Carousel.Item>
                    <img className="d-block w-100" src="/assests/singleItemPics/keychronK2Pic3.jpg" alt="" />
                </Carousel.Item>
            </Carousel>
        </div>
    )
